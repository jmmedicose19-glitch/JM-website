const productsData = [
  // 1. Pulse Lift EMS Face Lift
  {
    ...
    features: [
      { title: "RF and HIFES Technology", text: "Combines radiofrequency and high-intensity focused electrical stimulation for facial lifting and muscle stimulation applications." },
      { title: "Seven-Pad Applicator System", text: "Seven pads support targeted application across the forehead, eyebrows, cheeks and jawline." },
      { title: "12.1-Inch Operating Interface", text: "A 12.1-inch touchscreen provides the primary operating interface for configuring treatment parameters." },
      { title: "Product-Specific Configuration", text: "Operating modes and pad configuration may vary according to the supplied unit. Contact us for details." }
    ],
    ...
    infoTable: [
      ...
      { field: "Technology Type", value: "RF (Radiofrequency) & HIFES" },
      { field: "Applicator Format", value: "Seven pads" },
      { field: "Control Interface", value: "12.1-inch operating interface" },
  ...
  // 4. Fractional CO₂ Laser Machine
  {
    ...
    relatedIds: ["fractional-co2-v2", "truepico-laser", "pdt-hydrafacial"]
  },
  ...
  // 5. Diode Laser Machine
  {
    ...
    relatedIds: ["truepico-laser", "hifu-12d"]
  },
